...
const Cases = () => {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <span className="text-sm tracking-widest uppercase text-purple-600 font-semibold">
        Collection
        </span>
        ...
        Protect your device in style with durable, modern, and designer cases
        crafted to match your personality.
        </p>

        <div className="mt-10 w-16 h-1 bg-purple-600 mx-auto rounded-full"></div>
