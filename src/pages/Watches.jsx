...
const Watches = () => {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        Stay connected and track your lifestyle with premium smart watches
        designed for performance and everyday elegance.
        </p>

        <div className="mt-10 w-16 h-1 bg-emerald-600 mx-auto rounded-full"></div>
